...
import { Box, Button, Divider, Flex, Icon, Link, Text, useDisclosure } from '@chakra-ui/core';
  ...
  return (
    <Box mb="6px">
      ...
      <Flex
        ...
        p={{ xs: '1.4rem', sm: '1rem 2rem' }}
      >
        <Link aria-label="GitHub" href="https://github.com/trybick/tv-minder" isExternal>
          <Icon as={GithubIcon} h="1.7rem" id="bubbles" transition="color 0.2s" w="1.7rem" />
        </Link>
